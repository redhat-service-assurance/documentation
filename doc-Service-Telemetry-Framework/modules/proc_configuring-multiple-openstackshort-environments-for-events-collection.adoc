...
[id="configuring-multiple-openstackshort-environments-for-events-collection_{context}"]
= Configuring multiple {OpenStackShort} environments for events collection
